...
public:
	virtual BOOL m_OnCmdMsg (UINT nID, int nCode);
public:
...
public:
	virtual BOOL OnCmdMsg (UINT nID, int nCode)
	{
		...
		return CCmdTarget::m_OnCmdMsg (nID, nCode);
	}
public:
	DECLARE_MESSAGE_MAP ( )
};
...
public:
	virtual LRESULT m_WindowProc (UINT nMsg, WPARAM wParam, LPARAM lParam);
	virtual LRESULT m_DefWindowProc (UINT message, WPARAM wParam, LPARAM lParam)
	{
		cout << "CWnd::DefWindowProc()" << endl;
		return TRUE;
	}
	virtual BOOL m_OnCommand (WPARAM wParam, LPARAM lParam)
	{
		cout << "CWnd::OnCommand()" << endl;
		// ...
		return this->m_OnCmdMsg (0, 0);
	}
public:
	DECLARE_MESSAGE_MAP ( )
};
...
{
public:
	CView * m_viewActive;       // current active view
public:
	CFrameWnd () {
...
public:
	CView * m_GetActiveView ( ) const
	{
		cout << "CFrameWnd::GetActiveView()" << endl;
		return this->m_viewActive;
	}
	virtual BOOL m_OnCommand (WPARAM wParam, LPARAM lParam)
	{
		...
		return CWnd::m_OnCommand (wParam, lParam);
	}
	virtual BOOL m_OnCmdMsg (UINT nID, int nCode);
public:
	DECLARE_MESSAGE_MAP ( )
...
public:
	virtual BOOL m_OnCmdMsg (UINT nID, int nCode)
	{
		...
		if (CWnd::m_OnCmdMsg (nID, nCode))
			return TRUE;

		BOOL isHandled = FALSE;
		isHandled = m_document->m_OnCmdMsg (nID, nCode);
		return isHandled;
	}
public:
	DECLARE_MESSAGE_MAP ( )
